...
namespace TuitionDbv1.Controllers
{
    public class PplStaffsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StaffId,StaffName,StaffDesc,StaffPhone")] PplStaff pplStaff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StaffId,StaffName,StaffDesc,StaffPhone")] PplStaff pplStaff)
        {
