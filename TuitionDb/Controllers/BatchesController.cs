...
namespace TuitionDbv1.Controllers
{
    ...
    public class BatchesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("BatchId,BatchDay,BatchTime,BatchNotes,StaffName,SubjectName")] Batch batch)
        {
            if (!ModelState.IsValid)
            {
                _context.Add(batch);
            ...
            ViewData["StaffId"] = new SelectList(_context.Staffs, "StaffId", "StaffName", batch.StaffId);
            ViewData["SubjectId"] = new SelectList(_context.Subjects, "SubjectId", "SubjectName", batch.SubjectId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BatchId,BatchDay,BatchTime,BatchNotes,StaffName,SubjectName")] Batch batch)
        {
            if (id != batch.BatchId)
            {
                return NotFound();
